...
export const ErrorMessages = {
  profileMixup: createMessage({
    ...
    body: `Let me realign the arcane energies...`,
  }),
  ...
  networkError: createMessage({
    ...
    body: `Our magical pathways are experiencing interference...`,
  ...
  validationError: (field: string) =>
    createMessage({
      ...
      body: `The ${field} requires your attention...`,
  ...
  timeoutError: createMessage({
    ...
    body: `Our connection to the ethereal plane has weakened...`,
